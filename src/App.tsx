...
const sampleCertificates: Certificate[] = [
  ...
  { id: 'sample-2', certificate_number: 'CL2672337339', insured_name: "YANA AND YOMI'S TRANSPORTATION INC", holder_name: 'Master', policy_number: '02TRM068735-01', description: '2016 Freightliner, VIN #3ALACWDT1GDHG1434', issued_date: '2026-07-23', status: 'Issued' },
  { id: 'sample-3', certificate_number: 'CL2672337406', insured_name: "YANA AND YOMI'S TRANSPORTATION INC", holder_name: 'Master', policy_number: '02TRM068735-01', description: '2016 Freightliner, VIN #3ALACWDT1GDHG1434', issued_date: '2026-07-23', status: 'Issued' },
];
  ...
  return (
    <div className="app-shell">
      <header className="topbar">
        ...
        <div className="top-actions"><button aria-label="Links"><Link2 size={19} /></button><button aria-label="Notifications"><Bell size={19} /><i /></button><button aria-label="Help"><CircleHelp size={19} /></button><button className="user-menu"><span className="avatar">R</span><span>ROTALL1</span><ChevronDown size={15} /></button></div>
      </header>
...
function Policies() {
  return <div className="policy-layout"><div className="table-wrap"><div className="toolbar"><button><Plus size={14} /> New Policy</button><button>Copy</button><button>Endorse</button><button>Renew</button><button className="danger">Cancel</button><button>Compare</button><button>Export All</button></div><table><thead><tr><th>Policy #</th><th>Status</th><th>Term</th><th>Type</th><th>Company</th><th>Transaction</th><th>Effective</th></tr></thead><tbody><tr className="row-selected"><td className="link">02TRM068735-01</td><td><span className="pill green">Active</span></td><td>03/22/2026<br />03/22/2027</td><td>Package<br />CPKGE</td><td>Berkshire Hathaway<br />Homestate Insurance Company</td><td>Policy change</td><td>07/14/2026</td></tr></tbody></table></div><aside className="policy-summary"><h3>Policy Summary</h3><InfoBlock title="Basic Policy Information" lines={['Business New to Agency: N', 'Policy #: 02TRM068735-01', 'Policy Term: 03/22/2026 - 03/22/2027', 'Policy Type: Package', 'Transaction Date: 07/14/2026', 'Parent Company: Berkshire Hathaway Inc', 'Writing Company: Berkshire Hathaway Homestate Insurance Company', 'Division: Columbia', 'Branch: American Adventure', 'Department: Small Commercial']} /><InfoBlock title="Service Personnel" lines={['Primary Executive: Lynn Corrigan', 'Primary Representative: House Account']} /><InfoBlock title="First Named Insured" lines={["Name: JAMAR WILLIAMS", "Firm Name: YANA AND YOMI'S TRANSPORTATION INC", 'Business: (708) 362-0662', 'Email: yananndyomitransport@yahoo.com']} /></aside></div>;
}
